async function consultarTodosDados() {
  try {
    const response = await fetch("../repository/user-repository-mysql"); // Verifique o caminho correto da API
...
function preencherTabelaUsuarios(users) {
  const tabelaCorpo = document.querySelector("#tabelaUsuarios tbody"); // Corrigido o id aqui
